...
class GxEPD2_213_T5D : public GxEPD2_4G_EPD
{
  public:
    // attributes
    static const uint16_t WIDTH = 104;
    static const uint16_t HEIGHT = 212;
    static const GxEPD2_4G::Panel panel = GxEPD2_4G::GDEW0213T5D;
    ...
    static const uint16_t partial_refresh_time = 750; // ms, e.g. 704324us
    // constructor
